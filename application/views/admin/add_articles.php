...
?>
 ...
 //form_open(controller_name/function_name );
  ?>
  <?php echo form_hidden('userid',$this->session->userdata("user_id"));?>
    ...
    <?php echo form_input(['type'=>'text','name'=>'title', 'class'=>'form-control','placeholder'=>'enter Articles title' , 'value'=>set_value('title')]); ?>
    </div>
   </div>
   <div class="col-lg-6">
    <?php
...
<div class="form-group">
    ...
    -->
     <?php echo form_textarea(['type'=>'text','name'=>'article', 'class'=>'form-control','placeholder'=>'enter article Body' ,'value'=>set_value('article') ]); ?>
    ...
    <?php echo form_submit(['name'=>'submit' , 'value'=>'Add_Article' , 'class'=>'btn btn-info ']) ; ?>
